          ...
          <div className="row">
            ...
            <div className="col-12 col-md-9 col-lg-6 custom-profile-col">
              <div className="p-3 py-5">
                ...
                <div className="col-12 col-md-9 col-lg-6 custom-profile-col"><label className="labelscol">Mobile Number</label><input type="text" className="form-control" id="thirdbox" placeholder="(+970)" /></div>
                <div className="col-12 col-md-9 col-lg-6 custom-profile-col"><label className="labelscol">Email </label><input type="text" className="form-control" id="fourthbox" placeholder="Mohammed@info.com" /></div>

                <div className="row">
                  <div className="col-12 col-md-9 col-lg-6 custom-profile-col"><label className="labelscol">Date of Birth</label><input type="text" className="form-control" id="fifthbox" placeholder="dd/dd/yyyy" /></div>
                  <div className="col-12 col-md-9 col-lg-6 custom-profile-col"><label className="labelscol">Password</label><input type="text" className="form-control" id="sixthbox" placeholder="*********" /></div>
                </div>
